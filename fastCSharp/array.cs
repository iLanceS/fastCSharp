...
namespace fastCSharp
{
    ...
    public static partial class array
    {
        ...
        /// 数组数据
        /// </summary>
        public struct value<valueType> where valueType : class
        {
            /// <summary>
            /// 数据对象
            /// </summary>
        ...
        private sealed class order<valueType>
        {
            /// <summary>
            /// 升序委托
            /// </summary>
        ...
        {
            int index = binaryIndexOfLess(values, value, iComparable<valueType>.CompareToHandle);
            return index != values.Length && iComparable<valueType>.CompareToHandle(value, values[index]) == 0 ? index : -1;
        }
        /// <summary>
        /// 二分查找第一个匹配值位置
        /// </summary>
        ...
        {
            int index = binaryIndexOfLess(values, value, comparer, isAscending ? order<valueType>.Ascending : order<valueType>.Descending);
            return index != values.Length && comparer(value, values[index]) == 0 ? index : -1;
        }
        /// <summary>
        /// 二分查找第一个匹配值位置
        ...
        public static int binaryIndexOfLess<valueType>(this valueType[] values, valueType value)
            where valueType : IComparable<valueType>
        {
            return binaryIndexOfLess(values, value, iComparable<valueType>.CompareToHandle);
        }
        /// <summary>
        /// 二分查找匹配值之前的位置(用于查找插入值的位置)
        /// </summary>
        ...
        public static int binaryIndexOfLess<keyType, valueType>(this valueType[] values, keyType value
            ...
            , bool isAscending)
        {
            return binaryIndexOfLess(values, value, comparer, isAscending ? order<valueType>.Ascending : order<valueType>.Descending);
        }
        /// <summary>
        /// 二分查找匹配值之前的位置(用于查找插入值的位置)
        /// </summary>
        ...
        public static int binaryLastIndexOf<valueType>(this valueType[] values, valueType value)
            where valueType : IComparable<valueType>
        {
            int index = binaryIndexOfThan(values, value, iComparable<valueType>.CompareToHandle);
            return index != 0 && iComparable<valueType>.CompareToHandle(value, values[--index]) == 0 ? index : -1;
        }
        /// <summary>
        /// 二分查找最后一个匹配值位置
        /// </summary>
        ...
        public static int binaryLastIndexOf<keyType, valueType>(this valueType[] values, keyType value
            ...
            , bool isAscending)
        {
            int index = binaryIndexOfThan(values, value, comparer, isAscending ? order<valueType>.Ascending : order<valueType>.Descending);
            return index != 0 && comparer(value, values[--index]) == 0 ? index : -1;
        }
        /// <summary>
        /// 二分查找最后一个匹配值位置
        ...
        public static int binaryIndexOfThan<valueType>(this valueType[] values, valueType value)
            where valueType : IComparable<valueType>
        {
            return binaryIndexOfThan(values, value, iComparable<valueType>.CompareToHandle);
        }
        /// <summary>
        /// 二分查找匹配值之后的位置(用于查找插入值的位置)
        /// </summary>
        ...
        public static int binaryIndexOfThan<keyType, valueType>(this valueType[] values, keyType value
            ...
            , bool isAscending)
        {
            return binaryIndexOfThan(values, value, comparer, isAscending ? order<valueType>.Ascending : order<valueType>.Descending);
        }
        /// <summary>
        /// 二分查找匹配值之后的位置(用于查找插入值的位置)
        /// </summary>
        ...
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> left<valueType>(this valueType[] array, int count)
        {
            return array != null ? subArray<valueType>.Unsafe(array, 0, count <= array.Length ? count : array.Length) : default(subArray<valueType>);
        }
        /// <summary>
        /// 获取子段集合
        /// </summary>
        ...
        /// <returns>子段集合</returns>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> sub<valueType>(this valueType[] array, int index)
        {
            return array != null ? sub(array, index, -1) : default(subArray<valueType>);
        }
        /// <summary>
        /// 获取子段集合
        /// </summary>
        ...
        /// <returns>子段集合</returns>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> sub<valueType>(this valueType[] array, int index, int count)
        {
            if (array != null)
            {
        ...
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> toSubArray<valueType>(this valueType[] array)
        {
            if (array == null) return default(subArray<valueType>);
            return subArray<valueType>.Unsafe(array, 0, array.Length);
        }
        /// <summary>
        /// 转换成数组子串
        /// </summary>
        ...
        /// <returns>单向列表</returns>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> toSubArray<valueType>(this valueType[] array, int index, int length)
        {
            return subArray<valueType>.Create(array, index, length);
        }
        /// <summary>
        /// 根据集合内容返回单向列表
        /// </summary>
        ...
        public static subArray<arrayType> distinct<valueType, arrayType>(this valueType[] array, Func<valueType, arrayType> getValue)
        {
            if (array != null)
            {
        ...
        public static HashSet<hashType> getHash<valueType, hashType>(this valueType[] array, Func<valueType, hashType> getValue)
        {
            ...
            {
                if (getValue == null) log.Error.Throw(log.exceptionType.Null);
                HashSet<hashType> hash = hashSet<hashType>.Create();
            ...
            where keyType : IEquatable<keyType>
        {
            if (array != null)
            {
                Dictionary<keyType, valueType> dictionary = fastCSharp.dictionary<keyType>.Create<valueType>(array.Length << 1);
            ...
            where keyType : IEquatable<keyType>
        {
            if (array != null)
            {
                ...
                Dictionary<keyType, list<valueType>> newValues = fastCSharp.dictionary<keyType>.Create<list<valueType>>(array.Length << 1);
                list<valueType> list;
                foreach (valueType value in array)
                {
            ...
            where keyType : IEquatable<keyType>
        {
            ...
            {
                if (getKey == null) log.Error.Throw(log.exceptionType.Null);
                Dictionary<keyType, int> dictionary = fastCSharp.dictionary<keyType>.Create<int>(array.Length);
                int count;
                foreach (valueType value in array)
                {
                    keyType key = getKey(value);
        ...
        public static Dictionary<valueType, int> valueCount<valueType>(this valueType[] array)
        {
            ...
            {
                int count;
                Dictionary<valueType, int> dictionary = fastCSharp.dictionary.CreateAny<valueType, int>(array.Length << 1);
                foreach (valueType value in array)
                {
        ...
        public static subArray<valueType> intersect<valueType>(this valueType[] left, valueType[] right)
        {
            ...
            if (leftLength != 0)
            {
                ...
                if (rightLength != 0)
                {
                    valueType[] min = leftLength <= rightLength ? left : right, values = new valueType[min.Length];
                    HashSet<valueType> hash = hashSet<valueType>.Create();
                    int count = 0;
                    ...
                    return subArray<valueType>.Unsafe(values, 0, count);
                }
            }
            return default(subArray<valueType>);
        }
        ...
        public static IEnumerable<arrayType> getEnumerable<valueType, arrayType>(this valueType[] values, Func<valueType, arrayType> getValue)
        {
            if (values != null)
            {
        ...
        /// <param name="getValue">数据获取器</param>
        /// <returns>目标数组</returns>
        public static subArray<arrayType> concat<valueType, arrayType>(this valueType[] array, Func<valueType, subArray<arrayType>> getValue)
        {
            if (getValue == null) log.Error.Throw(log.exceptionType.Null);
            if (array != null)
            {
                subArray<arrayType> values = new subArray<arrayType>();
                foreach (valueType value in array) values.Add(getValue(value));
                return values;
            }
            return default(subArray<arrayType>);
        }
        ...
        /// <param name="count">数组数据数量</param>
        /// <param name="splitCount">子数组长度</param>
        /// <returns>分割后的数组集合</returns>
        internal static subArray<valueType>[] split<valueType>(this valueType[] array, int startIndex, int count, int splitCount)
        {
            int length = (count + splitCount - 1) / splitCount;
            subArray<valueType>[] newValues = new subArray<valueType>[length];
            int index = (--length) * splitCount, lastCount = count - index;
            index += startIndex;
            if (lastCount != 0) newValues[length--].UnsafeSet(array, index, lastCount);
            while (index != startIndex) newValues[length--].UnsafeSet(array, index -= splitCount, splitCount);
            return newValues;
        }
        /// <summary>
        /// 分割数组
        ...
        /// <returns>分割后的数组集合</returns>
        public static subArray<valueType>[] split<valueType>(this valueType[] array, int count)
        {
            return array != null && array.Length != 0 && count > 0 ? split(array, 0, array.Length, count) : nullValue<subArray<valueType>>.Array;
        }
        /// <summary>
        /// 分割数组
        /// </summary>
        ...
        public static keyValue<keyType, valueType>[] getKeyValue<keyType, valueType>(this keyType[] array, valueType[] values)
        {
            ...
            if (length != values.length()) log.Error.Throw(log.exceptionType.IndexOutOfRange);
            if (length != 0)
            {
                keyValue<keyType, valueType>[] newValues = new keyValue<keyType, valueType>[array.Length];
                int index = 0;
        ...
        public static subArray<valueType> getFind<valueType>(this valueType[] array, Func<valueType, bool> isValue)
        {
            if (isValue == null) log.Error.Throw(log.exceptionType.Null);
            if (array != null)
            {
                ...
                if (length != 0)
                {
                    ...
                    return subArray<valueType>.Unsafe(newValues, 0, length);
                }
            }
            return default(subArray<valueType>);
        }
        ...
        {
            if (isValue == null || getValue == null) log.Error.Throw(log.exceptionType.Null);
            int length = array.length();
            if (length != 0)
            {
                memoryPool pool = fastCSharp.memoryPool.GetDefaultPool(length = ((length + 31) >> 5) << 2);
        ...
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> pageSort<valueType>
            (this valueType[] array, Func<valueType, valueType, int> comparer, int pageSize, int currentPage, out int count)
        {
        ...
        /// <returns>分页排序数据</returns>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public static subArray<valueType> getPageSort<valueType>
            (this valueType[] array, Func<valueType, valueType, int> comparer, int pageSize, int currentPage)
        {
            array.page page = new array.page(array.length(), pageSize, currentPage);
        ...
        {
            valueType value;
            return max(array, iComparable<valueType>.CompareToHandle, out value) ? value : nullValue;
        }
        /// <summary>
        /// 获取最大值
        /// </summary>
        ...
        {
            valueType value;
            return max(array, getKey, iComparable<keyType>.CompareToHandle, out value) ? value : nullValue;
        }
        /// <summary>
        /// 获取最大值
        /// </summary>
        ...
        {
            valueType value;
            return max(array, getKey, iComparable<keyType>.CompareToHandle, out value) ? getKey(value) : nullValue;
        }
        /// <summary>
        /// 获取最大键值
        /// </summary>
        ...
        {
            valueType value;
            return min(array, iComparable<valueType>.CompareToHandle, out value) ? value : nullValue;
        }
        /// <summary>
        /// 获取最小值
        /// </summary>
        ...
        {
            valueType value;
            return min(array, getKey, iComparable<keyType>.CompareToHandle, out value) ? value : nullValue;
        }
        /// <summary>
        /// 获取最小值
        /// </summary>
        ...
        {
            valueType value;
            return min(array, getKey, iComparable<keyType>.CompareToHandle, out value) ? getKey(value) : nullValue;
        }
        /// <summary>
        /// 获取最小键值
        /// </summary>
