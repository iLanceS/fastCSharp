...
namespace fastCSharp
{
    ...
    /// 内存数据流
    /// </summary>
    public sealed class memoryStream : IDisposable
    {
        /// <summary>
        /// 内存流扩展设置
        /// </summary>
        private static readonly Action<MemoryStream, bool> memoryStreamExpandable = fastCSharp.emit.pub.UnsafeSetField<MemoryStream, bool>("_expandable");
        /// <summary>
        /// 默认容器初始尺寸
        /// </summary>
        ...
        public static implicit operator MemoryStream(memoryStream stream) 
        {
            if (stream.array.length() == 0) return new MemoryStream();
            MemoryStream memoryStream = UnsafeNew(stream.array);
        ...
        /// <param name="index">起始位置</param>
        /// <param name="count">写入字节数</param>
        internal void WriteNotNull(byte[] data, int index, int count)
        {
            prepLength(count);
            Buffer.BlockCopy(data, index, array, Length, count);
            Length += count;
        }
        /// <summary>
        /// 写数据
        ...
        /// <param name="index">起始位置</param>
        /// <param name="count">写入字节数</param>
        internal void UnsafeWrite(byte[] data, int index, int count)
        {
            Buffer.BlockCopy(data, index, array, Length, count);
            Length += count;
        }
        ...
        public unsafe void Write(char* start, int count)
        {
            if (start != null)
            {
                int length = count << 1;
                prepLength(length);
                fixed (byte* dataFixed = array) fastCSharp.unsafer.memory.Copy(start, dataFixed + Length, length);
                Length += length;
            }
        }
        /// <summary>
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(bool value)
        {
            array[Length++] = (byte)(value ? 1 : 0);
        }
        /// <summary>
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(sbyte value)
        {
            array[Length++] = (byte)value;
        }
        /// <summary>
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(short value)
        {
            array[Length++] = (byte)value;
            array[Length++] = (byte)((ushort)value >> 8);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(ushort value)
        {
            array[Length++] = (byte)value;
            array[Length++] = (byte)(value >> 8);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(char value)
        {
            array[Length++] = (byte)value;
            array[Length++] = (byte)(value >> 8);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(int value)
        {
            fixed (byte* dataFixed = array) *(int*)(dataFixed + Length) = value;
            Length += sizeof(int);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(uint value)
        {
            fixed (byte* dataFixed = array) *(uint*)(dataFixed + Length) = value;
            Length += sizeof(uint);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(long value)
        {
            fixed (byte* dataFixed = array) *(long*)(dataFixed + Length) = value;
            Length += sizeof(long);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(ulong value)
        {
            fixed (byte* dataFixed = array) *(ulong*)(dataFixed + Length) = value;
            Length += sizeof(ulong);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(DateTime value)
        {
            fixed (byte* dataFixed = array) *(long*)(dataFixed + Length) = value.Ticks;
            Length += sizeof(long);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(float value)
        {
            fixed (byte* dataFixed = array) *(float*)(dataFixed + Length) = value;
            Length += sizeof(float);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(double value)
        {
            fixed (byte* dataFixed = array) *(double*)(dataFixed + Length) = value;
            Length += sizeof(double);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(decimal value)
        {
            fixed (byte* dataFixed = array) *(decimal*)(dataFixed + Length) = value;
            Length += sizeof(decimal);
        }
        ...
        /// <param name="value">数据</param>
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public unsafe void UnsafeWrite(Guid value)
        {
            fixed (byte* dataFixed = array) *(Guid*)(dataFixed + Length) = value;
            Length += sizeof(Guid);
        }
        ...
        [MethodImpl((MethodImplOptions)fastCSharp.pub.MethodImplOptionsAggressiveInlining)]
        public void UnsafeWrite(byte[] data)
        {
            Buffer.BlockCopy(data, 0, array, Length, data.Length);
            Length += data.Length;
        }
        ...
        /// <param name="data">数据</param>
        /// <returns>内存流</returns>
        public static MemoryStream UnsafeNew(byte[] data)
        {
            MemoryStream memoryStream = new MemoryStream(data, 0, data.Length, true, true);
