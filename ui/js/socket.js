...
(function (fastCSharp) {
    var SocketBuffer = (function () {
        ...
        SocketBuffer.prototype.UShortString = function (Value) {
            if (Value.length < 65536) {
                ...
                if (Value.length)
                    this.PushString(Value, fastCSharp.Pub.ThisFunction(this, this.UShort));
            }
        };
        SocketBuffer.prototype.String = function (Value) {
            if (Value.length < (1 << 15)) {
                ...
                this.PushString(Value, fastCSharp.Pub.ThisFunction(this, Value.length < 65536 ? this.UShort : this.UInt));
            }
        };
    ...
    var Socket = (function () {
        function Socket(Parameter) {
            fastCSharp.Pub.GetParameter(this, Socket.DefaultParameter, Parameter);
            fastCSharp.Pub.GetEvents(this, Socket.DefaultEvents, Parameter);
            ...
            if (this.PingData) {
                ...
                setTimeout(fastCSharp.Pub.ThisFunction(this, this.Ping), this.PingTimeout);
            }
            if (this.AutoTimeout)
                this.Create();
        }
        Socket.prototype.Create = function () {
            if (!this.IsClose && !this.IsOpen) {
                ...
                this.WebSocket.onopen = fastCSharp.Pub.ThisFunction(this, this.Open, [this.Identity]);
                this.WebSocket.onclose = fastCSharp.Pub.ThisFunction(this, this.Close, [this.Identity]);
                this.WebSocket.onerror = fastCSharp.Pub.ThisFunction(this, this.Error, [this.Identity]);
                this.WebSocket.onmessage = fastCSharp.Pub.ThisFunction(this, this.Message, [this.Identity]);
            }
        };
        ...
        Socket.prototype.CloseSocket = function (IsClose) {
            ...
            this.WebSocket = null;
            if (this.AutoTimeout)
                setTimeout(fastCSharp.Pub.ThisFunction(this, this.Create), this.AutoTimeout);
        };
        Socket.prototype.Ping = function () {
            ...
            if (Timeout <= 0) {
                ...
                setTimeout(fastCSharp.Pub.ThisFunction(this, this.Ping), Timeout + 1);
        };
        Socket.prototype.Open = function () {
            if (this.CheckIdentity(arguments)) {
                ...
                ++this.IsQueue;
                setTimeout(fastCSharp.Pub.ThisFunction(this, this.SendQueue), 500);
            }
        };
