...
module fastCSharp {
    ...
    export class Pub {
        ...
        static FillQuery(Value: { [key: string]: string; }, Search: string) {
        ...
        static CreateQuery(Location: Location): { [key: string]: string; } {
            ...
            if (Hash.length) this.FillQuery(Value, Hash);
        ...
        static ModuleVersions: { [key: string]: string } = { 'htmlEditor': '4', 'ace/ace': '2', 'highcharts/highcharts': '2', 'mathJax/MathJax': '6' };
        ...
        private static LoadModuleWhenNull(Path: string, Version: string) {
            if (this.IsModules[Path] == null) {
                ...
                this.AppendJs(Loader.JsDomain + 'js/' + Path + '.js?v=' + (this.ModuleVersions[Path]||Version));
            }
        }
        ...
        static OnReadyState() {
            ...
            this.AppendJs(Loader.JsDomain + Path.substring(1) + '.js?v=' + Loader.Version);
        ...
        static CreateLoadViewQuery(): HttpRequestQuery {
            return new HttpRequestQuery(document.location.pathname, this.Query, this.ThisFunction(this, this.LoadView));
        }
        ...
        private static DefaultCallAjaxGet(Url: string, Send: Object = null, Callback: Function = null) {
            fastCSharp.HttpRequest.Get(Url, Send, Callback);
        }
        static CallAjaxGet: (Url: string, Send: Object, Callback: Function) => void;
        static GetAjaxGet(): (Url: string, Send: Object, Callback: Function) => void {
    ...
    export class HttpRequestQuery {
        ...
        constructor(Url: string, Send: Object = null, CallBack: Function = null) {
            this.Url = Url;
            this.Send = Send;
    ...
    export class HttpRequest {
        ...
        static CreateRequest(): XMLHttpRequest {
            ...
            fastCSharp.Pub.Alert('你的浏览器不支持服务器请求,请升级您的浏览器！');
            return null;
        }
        ...
        static GetQuery(HttpRequestQuery: HttpRequestQuery) {
            ...
            if (!Pub.IE && !HttpRequestQuery.IsRandom) {
                ...
                Query.Url = '__AJAX__?__AJAXCALL__=' + Query.Url + '&__CALLBACK__=fastCSharp.Pub.AjaxCallBack';
        ...
        static Get(Url: string, Send: Object = null, CallBack: Function = null) {
            this.GetQuery(new HttpRequestQuery(Url, Send, CallBack));
        }
        ...
        static CheckError(Value: Object, ErrorInfo = '服务器请求失败，请稍后重试'): boolean {
            if ((Value as IHttpRequestReturn).ErrorRequest) {
                if (ErrorInfo) fastCSharp.Pub.Alert(ErrorInfo);
                return false;
            }
            return true;
        }
    ...
    class SkinViewNode {
        ...
        private ReShowPushArrayExpand(MarkStart: HTMLElement) {
            ...
            Pub.DeleteElements.Html(this.Node.Skin.EndHtml()).Child().InsertBefore(fastCSharp.HtmlElement.$NextElement(MarkStart), HtmlElement.$ParentElement(MarkStart));
        }
        ...
        private ParameterId(Event: DeclareEvent): IDeclare {
            ...
            if (Element) {
                ...
                if (Parameter.Id) {
                    ...
                    if (!Element) return Declare.Declares[this.fastCSharpName][Parameter.Id];
                    Parameter = null;
                }
        ...
        private ParameterMany(Event: DeclareEvent): IDeclareMany {
            if (!Event.IsGetOnly) {
                ...
                if (Element) {
                    ...
                    Parameter.Event = Event;
                    if (Parameter.Id) {
                        var Value = Declare.Declares[this.fastCSharpName][Parameter.Id] as Object as IDeclareMany;
                        if (Value) {
                            Value.Reset(Parameter, Element);
                            return Value;
                        }
                        Declare.Declares[this.fastCSharpName][Parameter.Id] = (Value = this.NewDeclare(Parameter) as Object as IDeclareMany) as Object as IDeclare;
                        return Value;
                    }
                }
            }
            return Declare.Declares[this.fastCSharpName][Event.DeclareId] as Object as IDeclareMany;
        }
