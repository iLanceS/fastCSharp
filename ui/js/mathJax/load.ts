...
module fastCSharp {
    export class MathJaxLoader {
        ...
        private static Show() {
            ...
            if (Values.length) MathJax.Hub.Queue(['Typeset', MathJax.Hub, Values, {}], fastCSharp.Pub.ThisFunction(MathJaxLoader, MathJaxLoader.FixedBorder, [null, Values]));
        }
        private static FixedBorder(Element: HTMLElement, Elements: HTMLElement[] = null) {
            if (Elements) {
                ...
                for (var Elements = new fastCSharp.HtmlElement('.MathJax/nobr/span', Element).GetElements(), Index = Elements.length; Index;) {
        ...
        private static ShowElement(Element: HTMLElement) {
            ...
            MathJax.Hub.Queue(['Typeset', MathJax.Hub, Element], fastCSharp.Pub.ThisFunction(MathJaxLoader, MathJaxLoader.FixedBorder, [Element]));
        }
