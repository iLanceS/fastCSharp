module fastCSharp {
    ...
    export class OpenApi {
        ...
        private Login(Name: string) {
            ...
            else fastCSharp.Pub.Alert('未找到第三方 ' + Name + ' API信息');
        }
        private OnState(Value: fastCSharp.IHttpRequestReturn, Api: IOpenApi) {
            ...
            else fastCSharp.HttpRequest.CheckError(Value);
        }
