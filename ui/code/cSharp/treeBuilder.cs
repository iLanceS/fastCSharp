...
namespace fastCSharp.code
{
    ...
    internal sealed class treeBuilder
    {
        ...
        /// 所有command
        /// </summary>
        public readonly static string Commands = Enum.Array<coder.command>().joinString('|', value => value.ToString());
        /// <summary>
        /// command后续取值范围
        /// </summary>
        ...
        /// CSharp代码树节点
        /// </summary>
        internal sealed class node : template<node>.INode, code.treeBuilder<node, tag>.INode
        {
            /// <summary>
            /// 树节点标识
            /// </summary>
            ...
            public node GetFirstNodeByTag(coder.command command, string content)
            {
        ...
        /// 建树器
        /// </summary>
        private code.treeBuilder<node, tag> tree = new code.treeBuilder<node, tag>();
        /// <summary>
        /// CSharp代码建树器
        /// </summary>
        public treeBuilder() { }
        ...
        internal node create(string code)
        {
            if (code.length() != 0)
            {
                ...
                {
                    fastCSharp.code.error.Add(error);
                }
            }
            return null;
        }
