...
namespace fastCSharp.code
{
    ...
    internal static class error
    {
        ...
        /// 提示信息集合
        /// </summary>
        private static readonly HashSet<string> messages = hashSet.CreateOnly<string>();
        /// <summary>
        /// 错误信息集合
        /// </summary>
        private static readonly HashSet<string> errors = hashSet.CreateOnly<string>();
        /// <summary>
        /// 异常集合
        /// </summary>
...
"), false);
        ...
        public static bool Open(bool isClear)
        {
            if (Output() || IsMessage)
            {
                string fileName = log.Default.MoveBak();
