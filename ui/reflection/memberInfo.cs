...
namespace fastCSharp.ui.reflection
{
    /// <summary>
    /// 成员属性相关操作
    /// </summary>
    internal static class memberInfo
    {
        ...
        public static attributeType customAttribute<attributeType>
            (MemberInfo member, bool isBaseType = false, bool isInheritAttribute = false)
        ...
        //public static subArray<attributeType> customAttributes<attributeType>
        //    (this MemberInfo member, bool isInherit) where attributeType : Attribute
        //{
        //    if (member != null)
        //    {
        //        attributeType value;
        //        subArray<attributeType> values = default(subArray<attributeType>);
        ...
        //        return values;
        //    }
        //    return default(subArray<attributeType>);
        //}
    }
}
