...
using IntKey = fastCSharp.test.radixSort.key.int64;
...
namespace fastCSharp.test.radixSort
{
    class keyInt64
    {
        ...
        private static void random(IntKey[] key1, IntKey[] key2)
        {
            ...
            {
                --index;
                key2[index].Key = key1[index].Key = (long)fastCSharp.random.Default.NextULong();
            }
        }
        /// <summary>
        /// 排序测试
        ...
        private static void sort(IntKey[] key1, IntKey[] key2)
        {
            ...
            time.Stop();
            if (key1.Length < 1 << 10) Console.WriteLine("fastCSharp.getSort " + type + "[" + key1.Length.toString() + "] " + time.ElapsedTicks.ToString() + "t");
            else Console.WriteLine("fastCSharp.getSort " + type + "[" + key1.Length.toString() + "] " + time.ElapsedMilliseconds.ToString() + "ms");
            for (int index = key1.Length; index != 0;)
            {
                --index;
        ...
        private static void sortDesc(IntKey[] key1, IntKey[] key2)
        {
            ...
            time.Stop();
            if (key1.Length < 1 << 10) Console.WriteLine("fastCSharp.getSortDesc " + type + "[" + key1.Length.toString() + "] " + time.ElapsedTicks.ToString() + "t");
            else Console.WriteLine("fastCSharp.getSortDesc " + type + "[" + key1.Length.toString() + "] " + time.ElapsedMilliseconds.ToString() + "ms");
            for (int index = key1.Length; index != 0;)
            {
                --index;
                if (key11[index].Key != key2[index].Key)
        ...
        private static void sort(IntKey[] key1, IntKey[] key2, int startIndex, int length)
        {
            ...
            time.Stop();
            if (key1.Length < 1 << 10) Console.WriteLine("fastCSharp.getSort " + type + "[" + length.toString() + "] " + time.ElapsedTicks.ToString() + "t");
            else Console.WriteLine("fastCSharp.getSort " + type + "[" + length.toString() + "] " + time.ElapsedMilliseconds.ToString() + "ms");
        ...
        private static void sortDesc(IntKey[] key1, IntKey[] key2, int startIndex, int length)
        {
            ...
            time.Stop();
            if (key1.Length < 1 << 10) Console.WriteLine("fastCSharp.getSortDesc " + type + "[" + length.toString() + "] " + time.ElapsedTicks.ToString() + "t");
            else Console.WriteLine("fastCSharp.getSortDesc " + type + "[" + length.toString() + "] " + time.ElapsedMilliseconds.ToString() + "ms");
            for (int index = startIndex, endIndex = startIndex + length; index != endIndex; ++index)
            {
                if (key11[index - startIndex].Key != key2[index].Key) Console.WriteLine("Error");
            }
        }
        /// <summary>
        /// 排序测试
