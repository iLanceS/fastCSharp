...
namespace fastCSharp
{
    ...
    public struct bitMap
    {
        ...
        {
            this.size = size < 0 ? 0 : (uint)size;
            size = (int)((this.size + 7) >> 3);
            map = size > 0 ? new byte[size] : nullValue<byte>.Array;
        }
        /// <summary>
        /// 设置占位
        /// </summary>
    ...
    public struct bitMap<enumType> where enumType : IConvertible
    {
        ...
        /// 最大值
        /// </summary>
        private static readonly uint size = (uint)fastCSharp.Enum.GetMaxValue<enumType>(-1) + 1;
        /// <summary>
