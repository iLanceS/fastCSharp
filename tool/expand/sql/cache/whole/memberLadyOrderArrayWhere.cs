...
namespace fastCSharp.sql.cache.whole
{
        ...
        where targetType : class
    {
        ...
        public memberLadyOrderArrayWhere(events.cache<valueType, modelType> cache, Func<modelType, keyType> getKey
            , Func<keyType, targetType> getValue, Expression<Func<targetType, ladyOrderArray<valueType>>> member
            , Func<IEnumerable<targetType>> getTargets, Func<subArray<valueType>, subArray<valueType>> sorter, Func<valueType, bool> isValue)
