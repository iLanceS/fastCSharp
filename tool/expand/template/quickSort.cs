...
namespace fastCSharp.algorithm
{
    ...
    internal static partial class quickSort
    {
        ...
        /// <param name="startIndex">起始位置</param>
        /// <param name="endIndex">结束位置-1</param>
        internal unsafe static void sort/*Compare[0]*//*Compare[0]*/
        ...
        {
            unmanagedPool pool = fastCSharp.unmanagedPool.GetDefaultPool(values.Length * sizeof(/*Type[1]*/ulongSortIndex/*Type[1]*/));
            pointer.size data = pool.Get(values.Length * sizeof(/*Type[1]*/ulongSortIndex/*Type[1]*/));
            try
            {
        ...
        {
            /*Type[1]*/ulongSortIndex/*Type[1]*/.Create(fixedIndex, values, getKey);
