...
namespace fastCSharp.algorithm
{
    ...
    public struct /*Type[1]*/ulongSortIndex/*Type[1]*/
    {
        ...
        internal unsafe static void Create<valueType>(/*Type[1]*/ulongSortIndex/*Type[1]*/* indexFixed, valueType[] values, Func<valueType, /*Type[0]*/ulong/*Type[0]*/> getValue)
        {
            int index = 0;
        ...
        internal unsafe static void Create<valueType>(/*Type[1]*/ulongSortIndex/*Type[1]*/* indexFixed, valueType[] values, Func<valueType, /*Type[0]*/ulong/*Type[0]*/> getValue, int startIndex, int count)
        {
        ...
        internal unsafe static valueType[] Create<valueType>(/*Type[1]*/ulongSortIndex/*Type[1]*/* indexFixed, valueType[] values, int count)
        {
