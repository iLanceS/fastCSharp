...
namespace fastCSharp.net.packet
{
    ...
    public struct icmp
    {
        ...
        {
            get { return fastCSharp.unsafer.memory.GetUInt(data.UnsafeArray, data.StartIndex + 8); }
        }
        ...
        {
            get { return fastCSharp.unsafer.memory.GetUIntBigEndian(data.UnsafeArray, data.StartIndex + 16); }
        }
        ...
        {
            get { return fastCSharp.unsafer.memory.GetUInt(data.UnsafeArray, data.StartIndex + 4); }
        }
        ...
        */
        ...
        static icmp()
        {
            ...
            minTypeSize[(int)type.SourceClosed] = 8;
            minTypeSize[(int)type.Redirect] = 8;
            minTypeSize[(int)type.EchoRequest] = 8;
            minTypeSize[(int)type.RouterAdvertisement] = 8;
            minTypeSize[(int)type.RouterRequest] = 8;
            minTypeSize[(int)type.Timeout] = 8;
            //minTypeSize[(int)icmpType.ParameterError] = ;
            minTypeSize[(int)type.TimeRequest] = 20;
            minTypeSize[(int)type.TimeAnswer] = 20;
            minTypeSize[(int)type.MaskRequest] = 12;
            minTypeSize[(int)type.MaskAnswer] = 12;
            #endregion
        }
    }
}
