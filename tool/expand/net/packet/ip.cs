...
#pragma warning disable
        ...
        /// IP协议
        /// </summary>
        public enum protocol : byte//System.Net.Sockets.ProtocolType
        {
            /// <summary>
            /// 未知
            /// </summary>
...
#pragma warning restore
        ...
        {
            get { return (data.UnsafeArray[data.StartIndex] & 15) << 2; }
        }
        /// <summary>
        /// IP版本号
        /// </summary>
        ...
        public int Priority
        {
            get { return data.UnsafeArray[data.StartIndex + 1] >> 5; }
        }
        /// <summary>
        ...
        {
            get { return (data.UnsafeArray[data.StartIndex + 1] >> 1) & 15; }
        }
        /// <summary>
        ...
        {
            get { return (data.UnsafeArray[data.StartIndex + 6] & 0x40) != 0; }
        }
        /// <summary>
        /// 更多分片标志
        /// </summary>
        ...
        {
            get { return (data.UnsafeArray[data.StartIndex + 6] & 0x20) != 0; }
        }
        /// <summary>
        ...
        {
            get { return (((uint)data.UnsafeArray[data.StartIndex + 6] & 0x1f) << 8) + data.UnsafeArray[data.StartIndex + 7]; }
        }
        /// <summary>
        ...
        {
            get { return data.UnsafeArray[data.StartIndex + 8]; }
        }
        /// <summary>
        /// IP协议
        /// </summary>
        ...
        {
            get { return (protocol)data.UnsafeArray[data.StartIndex + 9]; }
        }
        /// <summary>
        /// 校验和
        /// </summary>
        ...
        {
            get { return ((uint)data.UnsafeArray[data.StartIndex + 10] << 8) + data.UnsafeArray[data.StartIndex + 11]; }
        }
        /// <summary>
        /// 源IP地址
        /// </summary>
        public uint Source
        {
            get { return fastCSharp.unsafer.memory.GetUInt(data.UnsafeArray, data.StartIndex + 12); }
        }
        /// <summary>
        /// 目的IP地址
        /// </summary>
        ...
        {
            get { return fastCSharp.unsafer.memory.GetUInt(data.UnsafeArray, data.StartIndex + 16); }
        }
        /// <summary>
        /// IP头扩展
        /// </summary>
        public subArray<byte> Expand
        {
            get
            {
                return HeaderSize > DefaultHeaderSize ? subArray<byte>.Unsafe(data.UnsafeArray, data.StartIndex + DefaultHeaderSize, HeaderSize - DefaultHeaderSize) : default(subArray<byte>);
            }
        }
        /// <summary>
        /// 下层应用数据包
        ...
        {
            fixed (byte* fixedData = data.UnsafeArray)
            {
