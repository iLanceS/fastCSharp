...
namespace fastCSharp
{
    ...
    public unsafe struct chineseEncoder
    {
        ...
        /// UTF32文件BOM
        /// </summary>
        private static readonly uint utf32Bom = file.GetBom(Encoding.UTF32).Bom;
        /// <summary>
        /// UTF8文件BOM
        /// </summary>
        private static readonly uint utf8Bom = file.GetBom(Encoding.UTF8).Bom;
        /// <summary>
        /// Unicode文件BOM
        /// </summary>
        private static readonly uint unicodeBom = file.GetBom(Encoding.Unicode).Bom;
        /// <summary>
        /// 大端Unicode文件BOM
        /// </summary>
        private static readonly uint bigEndianUnicodeBom = file.GetBom(Encoding.BigEndianUnicode).Bom;
        /// <summary>
        /// 当前位置
        /// </summary>
        private byte* start;
        ...
        private Encoding get(byte* dataFixed, int length)
        {
            ...
            unsafer.memory.Fill((byte*)(gb18030Char = gb18030Chars), 0UL, 0x40 * sizeof(char) / sizeof(ulong));
            ...
            *end++ = (byte)endValue;
            ...
            if (utf16Count >= 0)
            {
                ...
                unsafer.memory.Fill((byte*)(utf16Char = utf16Chars), 0UL, 0x10 * sizeof(char) / sizeof(ulong));
                ...
                unsafer.memory.Fill((byte*)(bigUtf16Char = bigUtf16Chars), 0UL, 0x10 * sizeof(char) / sizeof(ulong));
        ...
        private void utf8()
        {
            ...
            unsafer.memory.Fill((byte*)utf8Char, 0UL, 0x10 >> 1);
        ...
        private void big5()
        {
            ...
            unsafer.memory.Fill((byte*)big5Char, 0UL, 0x40 * sizeof(char) / sizeof(ulong));
        ...
        private void utf32()
        {
            ...
            unsafer.memory.Fill((byte*)utf32Char, 0UL, 0x10 >> 1);
