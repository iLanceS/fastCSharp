...
namespace fastCSharp.data
{
    ...
    /// <typeparam name="keyType2">关键字类型2</typeparam>
    /// <typeparam name="keyType3">关键字类型3</typeparam>
    /// <typeparam name="keyType4">关键字类型4</typeparam>
    public struct primaryKey<keyType1, keyType2, keyType3, keyType4> : IEquatable<primaryKey<keyType1, keyType2, keyType3, keyType4>>, IComparable<primaryKey<keyType1, keyType2, keyType3, keyType4>>
        where keyType1 : IEquatable<keyType1>, IComparable<keyType1>
        where keyType2 : IEquatable<keyType2>, IComparable<keyType2>
        where keyType3 : IEquatable<keyType3>, IComparable<keyType3>
        where keyType4 : IEquatable<keyType4>, IComparable<keyType4>
    {
        /// <summary>
        /// 关键字1
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            return Equals((primaryKey<keyType1, keyType2, keyType3, keyType4>)obj);
        }
        /// <summary>
        /// 关键字比较
        /// </summary>
        /// <param name="other">关键字</param>
        /// <returns>是否相等</returns>
        public bool Equals(primaryKey<keyType1, keyType2, keyType3, keyType4> other)
        {
        ...
        /// <param name="other">关键字</param>
        /// <returns>比较结果</returns>
        public int CompareTo(primaryKey<keyType1, keyType2, keyType3, keyType4> other)
        {
            int cmp = Key1.CompareTo(other.Key1);
            if (cmp == 0)
            {
